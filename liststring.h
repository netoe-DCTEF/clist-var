...
t_exemplo *criar_lista(char __string[])
{
    ...
    strcpy(p->string, __string); // atribui o valor passado
...
t_exemplo *buscar_elemento(char __string[], t_exemplo **ant)
{
...
int remover_elemento(char __string[])
{
    ...
    t_exemplo *elem = buscar_elemento(__string, &ant);
